...
urlpatterns = patterns('',
    ...
    url(r'^update_review/$', login_required(Update_Review.as_view()), name = 'update_review'),
    ...
    url(r'^contact_us_submit/$', Contact_Us_Submit, name='contact_us_submit'),
    ...
    url(r'^musician_details/(?P<music_id>[-\w]+)$', Musician_Details.as_view(), name = 'musician_details'),
