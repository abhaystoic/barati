...
class Venue_Details(Dashboard, View):
   try:
      def __init__(self):
         self.template_name = 'customers/venue_details.html'

      def get_context_data(self, **kwargs):
         context = super(Venue_Details, self).get_context_data(**kwargs)
         return context
      ...
      def get_venue_details(self, **kwargs):
         query = "select id, name from venues where id = " + str(self.kwargs['venue_id'])
         self.venue_details = m.Venues.objects.raw(query)
         return self.venue_details
      ...
      def get_user_review(self, *args, **kwargs):
         try:
            ...
            if request.user.username:
               ...
               ref_id = m.Venues.objects.get(id=self.kwargs['venue_id']).ref_id
