    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=10, choices=[(b'delivery', b'delivery'), (b'vendor', b'vendor'), (b'customer', b'customer')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('last_status_time', models.DateTimeField(null=True, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(max_length=10, choices=[(b'customer', b'customer'), (b'vendor', b'vendor'), (b'admin', b'admin')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rooms_details', models.CharField(max_length=800, null=True, blank=True)),
                ('number_of_rooms', models.IntegerField(null=True, blank=True)),
                ('per_room_per_day_cost', models.FloatField(null=True, blank=True)),
                ('actual_price', models.IntegerField()),
                ('discount_perc', models.FloatField(null=True, blank=True)),
                ('discount_rs', models.FloatField(null=True, blank=True)),
                ('discounted_price', models.FloatField(null=True, blank=True)),
                ('food_types', models.CharField(max_length=800, null=True, blank=True)),
                ('per_plate_cost_veg', models.FloatField(null=True, blank=True)),
                ('per_plate_cost_nonveg', models.FloatField(null=True, blank=True)),
                ...
                ('function_types', models.CharField(max_length=800, null=True, blank=True)),
                ('valet_parking', models.NullBooleanField()),
                ('parking_capacity_4_wheelers', models.IntegerField(null=True, blank=True)),
                ('parking_capacity_2_wheelers', models.IntegerField(null=True, blank=True)),
                ('generator_available', models.NullBooleanField()),
                ('generator_cost_type', models.CharField(max_length=50, null=True, blank=True)),
                ('generator_details', models.CharField(max_length=800, null=True, blank=True)),
                ('generator_cost', models.IntegerField(null=True, blank=True)),
                ('audio_video_equipment_details', models.CharField(max_length=800, null=True, blank=True)),
                ('wheelchair_accessible_details', models.CharField(max_length=800, null=True, blank=True)),
                ('stage_details', models.CharField(max_length=800, null=True, blank=True)),
                ('cutlery_and_crockery_details', models.CharField(max_length=800, null=True, blank=True)),
                ('service_staff_details', models.CharField(max_length=800, null=True, blank=True)),
                ('timestamp', models.DateTimeField(auto_now_add=True, null=True)),
                ('address', models.ForeignKey(blank=True, to='customers.Address', null=True)),
